...
1.  Build the article detail page (fetch real articles, render SummaryPanel + NutritionLabel, emit 3-layer provenance)
2.  Write E2E pipeline integration test (create playwright.config.ts, test full ingest→score→summarize flow)
3.  Fix pushSubscriptions.keys schema (store encrypted envelope properly)
4.  Include body in contentHash (minor hashContent signature change)
