...
- **CSS**: Linked properly via `<link rel="stylesheet" href="/_next/static/chunks/[root-of-the-server]__1zoeqi6._.css"
...
<header class="border-b border-paper-300">
  <div class="max-w-[1440px] mx-auto px-4 ...">
    ...
    <h1 class="font-editorial text-6xl sm:text-7xl lg:text-8xl font-[800] ...">OneStopNews</h1>
