...
proxy.ts	✅	Correct matcher pattern, async cookie check, redirect on missing session for /admin/*, zero DB calls
...
tsconfig.json	✅	strict: true, noUncheckedIndexedAccess: true, @/* path alias, verbatimModuleSyntax: true, erasableSyntaxOnly: true
