...
OneStopNews is a **topic-first news aggregation and AI summarization platform** that organizes public news content by _what it is about_ rather than _who published it_. It collects article metadata from many sources, normalizes and categorizes stories, and presents them in a calm, editorially-informed interface designed for both daily readers and enterprise analysts.
...
2. Offer **source-cited, disclosure-first AI summaries** that speed up comprehension while preserving the primacy of original articles. _(Refined from draft — grounded in trust research.)_
...
_(Last row added — grounded in Finding 4.)_
...
### 4.4 AI Summarization — Source-Cited Model _(Significantly refined)_
...
> **"Editorial Dispatch"** — The aesthetic of a wire service terminal meets a refined long-read publication. Not a news app. A _briefing room_. Every element has the weight of something worth reading.
...
### 6.3 AI Summary UX — Source-Cited Disclosure Model _(Significantly updated)_
...
### 7.4 Summarization — Source-Cited Model _(Significantly updated)_
...
### 7.5 Search and Filtering _(Updated — BM25 strategy)_
...
### 8.3 Next.js 16 Caching Strategy _(Fully updated)_
...
export const articles = pgTable(
  "articles",
  {
    ...
    contentAvailability: contentAvailabilityEnum(
...
## 13. AI Governance _(Substantially revised)_
...
### Phase 1 — Production Foundation _(MVP on new architecture)_
...
_End of Refined PRD v2.0 — OneStopNews_
