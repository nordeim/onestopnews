...
| `pnpm test`                                                                              | All 498 tests pass across 69 suites                               |
...
```bash
# Run all unit tests (498 tests across 69 suites, ~32s)
pnpm test
...
| :---------- | :---------------------- | :------------------------------------------------------- | :----------------------------- | :------------------------------- |
| Unit        | `pnpm test`             | Pure logic + mocked deps (vitest, jsdom env)             | 498 tests / 69 suites          | ~32s                             |
